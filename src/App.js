  ...
  return (
    <div style={{Color:'white', flex:1, backgroundColor:'#192734', height:'100%'}}> 
      ...
      <Carousel cards={[
        ...
        {'projName':'Genome Evolution', 'projDet': 'Game to show a cells behavior over the course of its life.', 'projLink':'abcd'},
        {'projName':'Prayer Library', 'projDet': 'Library to hold prayers and Bible search tool to find verses', 'projLink':'abcd'},
        {'projName':'Quick Silver', 'projDet': 'Automation of the onboarding new clients process at Apex Clearing.', 'projLink':'abcd'},
        {'projName':'Queue Scheduler', 'projDet': 'Daily Schedule creation with the Queue Data strcuture.', 'projLink':'abcd'},
        {'projName':'Business Database', 'projDet':'Database frontend in java for the business school', 'projLink': 'abcd'},
        {'projName':'Andon App', 'projDet': 'Cross platform mobile application to assist in the submission of quotes for Andon Specialties', 'projLink':'abcd'}
        ]}
        />
